...
class NetSuiteRawLayerWriter:
    ...
    def write_partition(
        ...
        Raises:
            NetSuiteRawLayerWriterError: on S3 write failure or invalid inputs.
        """
        ...
        try:
            ...
            raise NetSuiteRawLayerWriterError(
        ...
        try:
            ...
            _logger.warning(
                "netsuite_raw_metadata_write_failed",
                data_key=data_key,
        ...
        _logger.info(
            "netsuite_raw_partition_written",
            bucket=self._bucket,
            data_key=data_key,
            record_count=record_count,
            entity_id=entity_id,
    ...
    def write_partition_streaming(
        ...
        if total_count == 0:
            _logger.warning(
                "netsuite_streaming_write_zero_records",
                entity_id=entity_id,
                run_id=run_id,
            )
        ...
        try:
            ...
            _logger.warning(
                "netsuite_streaming_metadata_write_failed",
                partition_prefix=partition_prefix,
                error=type(exc).__name__,
            )

        _logger.info(
            "netsuite_streaming_partition_written",
            bucket=self._bucket,
            partition_prefix=partition_prefix,
