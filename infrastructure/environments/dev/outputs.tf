...
output "extraction_pipeline_lambda_arn" {
  description = "ARN of the extraction pipeline Lambda function."
  value       = module.lambda_pipeline.lambda_function_arn
}

output "state_machine_arn" {
  description = "ARN of the extraction pipeline Step Functions state machine."
  value       = module.orchestration.state_machine_arn
}

output "schedule_group_name" {
  description = "EventBridge Scheduler schedule group name for entity extractions."
